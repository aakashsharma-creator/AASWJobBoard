...
$users = get_users(['role' => 'employer']);
?>
<div class="wrap udp-admin-page">
    <h1 class="udp-page-title">Employer List</h1>

    <div class="udp-card">
        <div class="udp-card-header">
            <h2>All Employers</h2>
            <p class="udp-subtitle">Below is a list of all users with the role <strong>Employer</strong>.</p>
        </div>
            ...
            <table class="udp-table display" style="width:100%">
                ...
                <?php foreach ($users as $key => $user): ?>
                    <tr>
                        ...
                        <td>
                            <button class="button button-primary udp-view-user-employer" data-user="<?php echo esc_attr($user->ID); ?>">View</button>
                        </td>
                    </tr>
                <?php endforeach; ?>
                </tbody>
