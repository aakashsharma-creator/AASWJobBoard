...
@keyframes spin {
  ...
  <div class="container">
    ...
    <div class="search-container" id="filtersContainer" style="display:none;">
    ...
    <div class="main-content" style="margin-top:20px;">
      <div class="job-list" style="height:auto">
      ...
      <?php /*?><div class="job-details" id="job-details">
  ...
  <script>
    jQuery(document).ready(function($) {
      ...
      $('.job-cards').on('click', '.job-card', function() {
        ...
        $('#jobDetailPopupContent').html('<div class="loader-wrapper"><div class="spinner"></div></div>');
        ...
        $.ajax({
          ...
          success: function(response) {
            $('#jobDetailPopupContent').html(response);
			
          },
          error: function() {
            $('#jobDetailPopupContent').html('<p style="text-align:center;">Error loading job details.</p>');
          }
        });
      });
	  
		// Close Popup
		$(document).on('click', '#closeJobPopup', function(){
		$('#job-details').fadeOut();
		});
...
/*          let firstCard = $('.job-cards .job-card').first();
          if (firstCard.length) {
            ...
            $('#jobDetailPopupContent').html(`<div style="
                    display: flex;
