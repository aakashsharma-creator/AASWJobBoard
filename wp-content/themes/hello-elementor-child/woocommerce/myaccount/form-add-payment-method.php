...
<div class="loader-overlay" id="loader" style="display:none;">
  <img src="<?php echo site_url(); ?>/wp-content/uploads/2025/10/loading-aasw-logo-1.jpg" alt="Loading..." class="loader-logo">
	...
	<?php }else{
		echo '<h2 class="cardpagetitle">You have already added multiple cards for doing the payments. Please manager your cards from here:</h2>';
		echo '<a class="managecards" href="'.site_url().'/my-account/payment-methods/">Manage your cards:</a>';
	} ?>
