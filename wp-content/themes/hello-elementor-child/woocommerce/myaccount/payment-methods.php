...
<?php if ( $has_methods ) : ?>
	...
	<h2 class="woo-payment-title">Payment Methods</h2>
...
<?php if ( WC()->payment_gateways->get_available_payment_gateways() ) : 
	...
	if($count_cards < 2){
	?>
		<a class="button add-payment-btn" href="<?php echo esc_url( wc_get_endpoint_url( 'add-payment-method' ) ); ?>"><?php esc_html_e( 'Add payment method', 'woocommerce' ); ?></a>
	<?php 
	}else{
		echo '<h3 class="card-limit-notice">Note: You’ve reached the limit of two saved cards. To add another, please delete one of your existing cards.</h3>';
	}
